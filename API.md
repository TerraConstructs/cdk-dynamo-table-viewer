...
| <code><a href="#@tcons/cdk-dynamo-table-viewer.TableViewer.with">with</a></code> | Applies one or more mixins to this construct. |
...
##### `with` <a name="with" id="@tcons/cdk-dynamo-table-viewer.TableViewer.with"></a>
...
###### `mixins`<sup>Required</sup> <a name="mixins" id="@tcons/cdk-dynamo-table-viewer.TableViewer.with.parameter.mixins"></a>
